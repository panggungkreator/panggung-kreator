...
export default function TentangHeroSection() {
  ...
  return (
    <section className="relative bg-white dark:bg-[#2c2c2c] border-b border-[#2c2c2c] dark:border-white min-h-[60vh] md:min-h-[70vh] flex flex-col justify-center p-8 md:p-16 lg:p-24 z-10">
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          Komunitas pengembangan diri berbasis di Bandung yang membantu setiap individu berani tampil, kreatif berkarya, dan membangun personal branding yang berdampak.
        </p>
      </div>
    </section >
  );
