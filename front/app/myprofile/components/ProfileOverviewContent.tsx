...
export default function ProfileOverviewContent({
  ...
  return (
    <div className="bg-transparent border-0 p-0 space-y-8 shadow-none w-full animate-fade-in text-[#212121] dark:text-[#F4F4F4] font-sans">
      ...
      {/* 📱 MOBILE HERO TALENT PROFILE (FULL WIDTH NO PADDING / NO BORDER RADIUS) */}
      <div className="md:hidden flex flex-col pb-8 border-b border-[#212121]/10 dark:border-white/10 w-full">
        {/* Full-width tall portrait photo canvas */}
        <div className="sticky top-16 sm:top-20 z-0 w-full aspect-[4/5] max-h-[460px] bg-neutral-900 text-white overflow-hidden rounded-none shadow-none p-0 relative">
        ...
        {/* Content Details Container (Full width, rounded top-left & top-right) */}
        <div className="relative z-10 w-full m-0 bg-[#F6F5FA] dark:bg-[#0E1210] text-[#212121] dark:text-[#F4F4F4] rounded-t-xl sm:rounded-t-[48px] pt-5 px-4 sm:px-6 pb-0 border-0 shadow-none flex flex-col items-center text-center">
          {/* Name */}
      ...
      {/* WRAPPER KONTEN (PADDED PADA MOBILE & SPACING LEGA ANTAR SECTION) */}
      <div className="px-4 sm:px-0 mt-6 sm:mt-8 space-y-10 sm:space-y-12">
        ...
        <div className="hidden md:flex md:flex-row items-start gap-6 sm:gap-8 pb-8 border-b border-[#212121]/10 dark:border-white/10">
          ...
          <div className="flex-1 w-full flex flex-col justify-end self-stretch py-0.5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2.5 gap-x-5 pt-3.5 border-t border-[#212121]/10 dark:border-white/10 text-xs">
              {member.city && (
            ...
            <div className="pt-3.5 flex flex-wrap items-center justify-between gap-3 border-t border-[#212121]/10 dark:border-white/10">
              {/* Social Icons */}
        ...
        <div className="space-y-4">
          <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between border-b border-[#212121]/10 dark:border-neutral-800 pb-3.5 sm:pb-4 gap-1.5 sm:gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6 pt-2">
            ...
            <div className="lg:col-span-4 p-5 sm:p-6 rounded-2xl bg-[#CFDECA]/25 dark:bg-[#CFDECA]/10 border border-[#CFDECA]/50 dark:border-[#CFDECA]/20 flex flex-col justify-between space-y-5 shadow-2xs">
              <div>
              ...
              <div className="pt-3.5 border-t border-[#212121]/10 dark:border-white/10 space-y-1.5">
            ...
            <div className="lg:col-span-8 p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#151B18] border border-[#212121]/10 dark:border-white/10 flex flex-col justify-between space-y-4 shadow-2xs">
              <div className="flex items-center justify-between gap-2">
                ...
                {/* LEGEND BADGE */}
                <div className="flex items-center gap-1.5 text-[9px] font-mono text-neutral-600 dark:text-neutral-400 shrink-0">
              ...
              <div className="grid grid-cols-8 sm:grid-cols-16 gap-2 sm:gap-2.5 py-2">
              ...
              <div className="flex items-center justify-between text-[9px] font-mono text-neutral-400 dark:text-neutral-500 pt-2.5 border-t border-[#212121]/10 dark:border-white/10">
                <span>SESI 01</span>
                <span>SESI 08</span>
                <span>SESI 16</span>
              </div>
        ...
        {(interests?.ps_challenges || interests?.nervous_trigger || interests?.confidence_scale) && (
          <div className="space-y-4 pt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 pt-2">
              ...
              <div className="md:col-span-7 p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#151B18] border border-[#212121]/10 dark:border-white/10 space-y-4 shadow-2xs">
                <div>
              ...
              <div className="md:col-span-5 p-5 sm:p-6 rounded-2xl bg-[#D8DFE9]/25 dark:bg-[#D8DFE9]/10 border border-[#D8DFE9]/50 dark:border-[#D8DFE9]/20 flex flex-col justify-between space-y-4 shadow-2xs">
                <div className="space-y-2">
                  <span className="inline-block text-[10px] font-mono font-bold uppercase tracking-wider bg-[#212121] dark:bg-white text-white dark:text-[#212121] px-2.5 py-0.5 rounded-md">
                    PEMICU GUGUP UTAMA
                  </span>
                ...
                <div className="pt-3.5 border-t border-[#212121]/10 dark:border-white/10 space-y-2">
                  ...
                  <div className="w-full bg-white/70 dark:bg-neutral-800 h-2.5 rounded-full overflow-hidden border border-black/5">
                    <div
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 pt-2">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#151B18] border border-[#212121]/10 dark:border-white/10 space-y-4 shadow-2xs">
              ...
              <div className="space-y-1.5 pt-3.5 border-t border-[#212121]/10 dark:border-white/10">
                <span className="inline-block text-[10px] font-mono font-bold uppercase tracking-wider bg-[#CFDECA] text-[#1E301B] dark:bg-[#253822] dark:text-[#CFDECA] px-2.5 py-0.5 rounded-md">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 pt-2">
            ...
            <div className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#151B18] border border-[#212121]/10 dark:border-white/10 space-y-3.5 shadow-2xs">
