          ...
          {step === 3 && (
            <div className="w-full space-y-6 py-4 animate-fade-in text-zinc-900 dark:text-white">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400 font-sans leading-relaxed max-w-md">
                Formulirmu sudah tersimpan aman. <span className="font-bold text-zinc-900 dark:text-white">Detailnya cek inbox atau spam email kamu ya</span>. Kamu akan mendapatkan update keseruan, info event, tips & program terbaru Panggung Kreator.
              </p>
