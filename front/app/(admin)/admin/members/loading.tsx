    ...
    <div className="space-y-6 pb-28 md:pb-12 animate-pulse select-none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="bg-bg-card border border-border-default/70 rounded-3xl p-4 sm:p-5 space-y-3"
          >
            ...
            <div className="h-2.5 w-32 bg-zinc-200 dark:bg-zinc-800 rounded"></div>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="grid grid-cols-2 sm:flex gap-2 sm:gap-3">
          <div className="h-10 w-full sm:w-44 bg-zinc-200 dark:bg-zinc-800 rounded-xl"></div>
          <div className="h-10 w-full sm:w-44 bg-zinc-200 dark:bg-zinc-800 rounded-xl"></div>
        </div>
      </div>
        ...
        {[1, 2, 3, 4].map((i) => (
          ...
          >
            ...
            <div className="space-y-2 py-1">
              <div className="h-5 w-3/5 bg-zinc-200 dark:bg-zinc-800 rounded"></div>
